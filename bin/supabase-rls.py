...
def http_check(env_path):
    ...
    public_tables = {"congestion_control_algorithms", "emulated_parent_runs", "emulated_runs", "emulated_snapshot_stats", "real_world_runs", "real_world_reports", "real_world_status_history"}
    for table in tables:
